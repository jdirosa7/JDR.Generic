...
namespace JDR.Generic.UI.Web.Controllers
{
    public class BankAccountController : Controller
    {
        ...
        {
            List<Account> data = dbBank.GetAccounts();
        ...
        public JsonResult SubmitDeposit(BankOperation operation)
        {
            try
            {
        ...
        public ActionResult SubmitExtract(BankOperation operation)
        {
            try
            {
        ...
        public ActionResult SubmitTransfer(BankOperation operation)
        {
            try
            {
